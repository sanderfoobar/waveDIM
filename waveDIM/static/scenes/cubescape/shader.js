THREE.PenisShader = {
	...
	fragmentShader: `
        ...
        // Converted to three.js by sander ferdinand
        ...
        float dbox( vec3 p, vec3 b, float r ){ return length(max(abs(p)-b,0.0))-r; }
        ...
        void mainImage( out vec4 fragColor, in vec2 fragCoord ) 
        {
            ...
            //-----------
            float time = 5.0 + 0.2*iGlobalTime + 20.0*1.0/iResolution.x;
